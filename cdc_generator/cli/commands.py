...
PIPELINE_COMMANDS: dict[str, dict[str, str]] = {
    "generate": {
        ...
        "description": "Generate Bento pipelines",
        "usage": "cdc manage-pipelines generate [customer] [--all] [--force]",
    },
    "list": {
        "runner": "generator",
        "module": "cdc_generator.cli.pipeline_list",
        "script": "cli/pipeline_list.py",
        "description": "List available customers and generated pipeline summary",
        "usage": "cdc manage-pipelines list [--status]",
    },
    "verify": {
        "runner": "generator",
        "module": "cdc_generator.cli.pipeline_verify",
        "script": "cli/pipeline_verify.py",
        "description": "Verify pipeline templates/configuration (light/full/sink modes)",
        "usage": "cdc manage-pipelines verify [--full] [--sink]",
    },
    "diff": {
        "runner": "generator",
        "module": "cdc_generator.cli.pipeline_diff",
        "script": "cli/pipeline_diff.py",
        "description": "Detect drift in generated pipeline files",
        "usage": "cdc manage-pipelines diff",
    },
    "health": {
        "runner": "generator",
        "module": "cdc_generator.cli.pipeline_health",
        "script": "cli/pipeline_health.py",
        "description": "Check Bento/runtime readiness",
        "usage": "cdc manage-pipelines health [--url <endpoint>]",
    },
    "prune": {
        "runner": "generator",
        "module": "cdc_generator.cli.pipeline_prune",
        "script": "cli/pipeline_prune.py",
        "description": "Detect/remove orphaned generated pipeline files",
        "usage": "cdc manage-pipelines prune [--confirm]",
    },
}
