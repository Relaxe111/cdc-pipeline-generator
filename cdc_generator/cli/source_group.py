...
from cdc_generator.cli.source_group_special_handlers import (
    handle_add_source_custom_key,
    handle_db_definitions,
    handle_introspect_types,
)
...
def _handle_introspect_types(args: argparse.Namespace) -> int:
    ...
    return handle_introspect_types(args)
