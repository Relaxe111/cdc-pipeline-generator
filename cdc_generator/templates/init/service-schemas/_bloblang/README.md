...
templates:
  user_status:
    ...
    type: text
    value: file://services/_schemas/_bloblang/examples/user_status_mapper.blobl
...
rules:
  calculate_priority:
    ...
    mapping: file://services/_schemas/_bloblang/examples/priority_calculator.blobl
...
- ✅ `file://services/_schemas/_bloblang/examples/user_status_mapper.blobl`
- ✅ `file://services/_schemas/_bloblang/my_custom_logic.blobl`
...
```bash
rpk connect lint services/_schemas/_bloblang/examples/user_status_mapper.blobl
```
